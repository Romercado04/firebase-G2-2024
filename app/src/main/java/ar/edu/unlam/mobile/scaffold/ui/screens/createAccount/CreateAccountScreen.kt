...
import ar.edu.unlam.mobile.scaffold.ui.components.TextFieldOwn
import ar.edu.unlam.mobile.scaffold.ui.components.TextFieldPassword
        ...
        ExtendedFloatingActionButton(
            onClick = {
                if (createAccountVM.validateEmail(createAccountVM.email.value) &&
                    createAccountVM.validatePassword(createAccountVM.password.value)
                ) {
